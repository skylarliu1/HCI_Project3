...
def play10():
    playsound('10.wav', False)
def play11():
    playsound('11.wav', False)
def play12():
    playsound('12.wav', False)
def play13():
    playsound('13.wav', False)
def play14():
    playsound('14.wav', False)
...
def listen_to_speech():
    ...
    while not quit:
        ...
        try:
            ...
            if recog_results == "easy" or recog_results == "one":
                client.send_message('/l', 1)
            if recog_results == "hard" or recog_results == "two":
                client.send_message('/l', 2)
            if recog_results == "insane" or recog_results == "three":
...
# -------------- Ball position: you can find it here -------
    def update_ball(self):
        ...
        if (game_start == 1):
            if(b.y >= 0 and b.y < 30):
                play0()
            if(b.y >= 30 and b.y < 60):
                play1()
            if(b.y >= 60 and b.y < 90):
                play2()
            if(b.y >= 90 and b.y < 120):
                play3()
            if(b.y >= 120 and b.y < 50):
                play4()
            if(b.y >= 150 and b.y < 180):
                play5()
            if(b.y >= 180 and b.y < 210):
                play6()
            if(b.y >= 210 and b.y < 240):
                play7()
            if(b.y >= 240 and b.y < 270):
                play8()
            if(b.y >= 270 and b.y < 300):
                play9()
            if(b.y >= 300 and b.y < 330):
                play10()
            if(b.y >= 330 and b.y < 360):
                play11()
            if(b.y >= 360 and b.y < 390):
                play12()
            if(b.y >= 290 and b.y < 420):
                play13()
            if(b.y >= 420 and b.y < 450):
                play14()
